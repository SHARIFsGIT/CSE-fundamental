...
5) Hack Binary Tree:
    ...
    For a complete binary tree: Number of edges = 2^(height - 1) + (number of leaf nodes) -1
    ...
    4) Maximum possible Height of a Binary Tree with n Nodes:
    For a binary tree with n nodes: Maximum height = n - 1

    5) Number of Internal Nodes in a Binary Tree:
    For a binary tree: Number of internal nodes = Total number of nodes - Number of leaf nodes

    6) Maximum Width of a Binary Tree (Number of Nodes in the Widest Level):
